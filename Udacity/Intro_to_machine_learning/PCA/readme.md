changing n_components to the following values: [10, 15, 25, 50, 100, 250] produces the results below. Exercise looks at F1 score for Ariel Sharon. n_components = 10 precision recall f1-score support
